...
const StepGuide = () => {
  ...
  <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
      <div className="text-center">
          <h2 className="text-3xl font-bold leading-tight text-gray-900 sm:text-4xl xl:text-5xl font-pj">Professional GuideLine</h2>
          <p className="mt-4 text-base leading-7 text-gray-600 sm:mt-8 font-pj">You Can add Your own Tour Facilities and More </p>
      </div>
      ...
      <div className="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-0 xl:mt-24">
          <div className="md:p-8 lg:p-14">
              ...
              <p className="mt-5 text-base text-gray-600 font-pj">If you want join with us and share your Trip.Then you will get Support all time. And if you need any Help we will Provide everything.</p>
          </div>
          ...
          <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
              ...
              <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Booking</h3>
              <p className="mt-5 text-base text-gray-600 font-pj">You will add your Tour Spot and require all information in the add touristSpot card . After add your tour spot anyone can book your tour trip.</p>
          </div>
          ...
          <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
              ...
              <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Your Tour Card</h3>
              <p className="mt-5 text-base text-gray-600 font-pj">You should give every information of your trip and a good image. and make sure all information are valid.</p>
          </div>
          ...
          <div className="md:p-8 lg:p-14 md:border-t md:border-gray-200">
              ...
              <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">After Booked</h3>
              <p className="mt-5 text-base text-gray-600 font-pj">If anyone Booked your trip you will get all information of who booked via email. And you will get a notification.</p>
          </div>
          ...
          <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
              ...
              <p className="mt-5 text-base text-gray-600 font-pj">You have make your trip journey and Facilities good.Because we are adding user rating system.So if you want to keep your rating high you have provide best Quality service.</p>
          </div>
          ...
          <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
              ...
              <p className="mt-5 text-base text-gray-600 font-pj">After if you do everything as GuideLine your business will grow and Popular.</p>
          </div>
      </div>
  </div>
</section>
